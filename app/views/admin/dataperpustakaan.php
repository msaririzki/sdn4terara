...
<body>
      ...
      <div class="container">
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              <h3 class="fw-bold mb-3">Perpustakaan</h3>
              <h6 class="op-7 mb-2">Lihat daftar buku dan link referensi perpustakaan</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
              <a class="btn btn-primary btn-round" href="#" data-bs-toggle="modal" data-bs-target="#addBook">Tambah
                Buku</a>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="add-row" class="display table table-striped table-hover dataTable" role="grid"
                          ...
                          <thead>
                            <!-- header tabel data perpustakaan -->
                            <tr role="row">
                          ...
                          <tbody>
                            <?php foreach ($data['buku'] as $bk): ?>
                              <tr role="row" class="odd">
                                <!-- cover-->
                                <td class="sorting_1">
                                  <img src="<?= BASEURL . '/upload/' . $bk['gambar_buku']; ?>" alt="" height="70"
                                    width="60">
                                </td>
                                <!-- link buku -->
                                <td class="sorting_1">
                                ...
                                <td>
                                  <a href="<?= $bk['link_buku']; ?>" target="_blank"><?= $bk['link_buku']; ?></a>
                                ...
                                <td>
                                  <div class="form-button-action">
                                    ...
                                    <button type="button" title="" class="btn btn-link btn-primary btn-lg"
                                      data-original-title="Edit Book" data-bs-toggle="modal" data-bs-target="">
                                      <i class="fa fa-edit">
                                        <a href="<?= BASEURL ?>/admin/editperpustakaan/<?= $bk['id_buku'] ?>">Edit</a>
                                      </i>
                                    </button>
                                    <!-- menghapus content -->
                                    <button type="button" data-bs-toggle="tooltip" title=""
                                      ...
                                      <i class="fa fa-times">
                                        <a href="<?= BASEURL ?>/admin/hapusBuku/<?= $bk['id_buku'] ?>"
                          ...
                          <ul class="pagination">
                            <?php if ($data['currentPage'] > 1): ?>
                              <li class="paginate_button page-item previous" id="add-row_previous">
                                <a href="<?= BASEURL ?>/admin/dataperpustakaan/<?= $data['currentPage'] - 1 ?>"
                            ...
                            <?php for ($i = 1; $i <= $data['totalPages']; $i++): ?>
                              <li class="paginate_button page-item <?= $i == $data['currentPage'] ? 'active' : '' ?>">
                                <a href="<?= BASEURL ?>/admin/dataperpustakaan/<?= $i ?>" aria-controls="add-row"
  ...
  <!-- Modal Pop Up -->
  <!-- konfigurasi untuk menambahkan buku perpustakaan -->
  <div class="modal fade" id="addBook" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Buku Perpustakaan</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="addBookForm" method="POST" action="<?= BASEURL ?>/admin/tambahBuku" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" id="sampul" name="gambarBuku" accept=".jpg, .jpeg, .png">
  ...
  <script>
    document.getElementById('searchButton').addEventListener('click', function () {
      ...
      if (query) {
        window.location.href = '<?= BASEURL ?>/admin/dataperpustakaan/search/' + encodeURIComponent(query);
      }
    });
  </script>
</body>