  ...
  <div class="wrapper">
        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            ...
            <div class="ms-md-auto py-2 py-md-0">
              <a class="btn btn-primary btn-round" href="#" data-bs-toggle="modal" data-bs-target="#addUser">Tambah
                Berita</a>
            </div>
          </div>
          <!-- tabel data berita -->
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="add-row" class="display table table-striped table-hover dataTable" role="grid"
                          ...
                          <!-- content tabel -->
                          <tbody>
                            <?php foreach ($data['berita'] as $bt): ?>
                              <tr role="row" class="odd">
                                <!-- foto -->
                                <td class="sorting_1">
                                  <img src="<?= BASEURL . '/upload/' . $bt['gambar_berita']; ?>" alt="" height="60"
                                    width="60">
                                </td>
                                <!-- judul berita -->
                                <td class="sorting_1">
                                ...
                                <td>
                                  <div class="form-button-action">
                                    ...
                                    <button type="button" title="" class="btn btn-link btn-primary btn-lg">
                                      <i class="fa fa-edit">
                                        <a href="<?= BASEURL ?>/admin/editberita/<?= $bt['id_berita'] ?>">Edit</a>
                                      </i>
                                    </button>
                                    <!-- menghapus content -->
                                    <button type="button" data-bs-toggle="tooltip" title=""
                                      ...
                                      <i class="fa fa-times">
                                        <a href="<?= BASEURL ?>/admin/hapusBerita/<?= $bt['id_berita'] ?>"
                          ...
                          <ul class="pagination">
                            <?php if ($data['currentPage'] > 1): ?>
                              <li class="paginate_button page-item previous" id="add-row_previous">
                                <a href="<?= BASEURL ?>/admin/databerita/<?= $data['currentPage'] - 1 ?>"
                            ...
                            <?php for ($i = 1; $i <= $data['totalPages']; $i++): ?>
                              <li class="paginate_button page-item <?= $i == $data['currentPage'] ? 'active' : '' ?>">
                                <a href="<?= BASEURL ?>/admin/databerita/<?= $i ?>" aria-controls="add-row"
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded-0 border-0 p-4">
          ...
          <div class="modal-body">
            <form action="<?= BASEURL; ?>/admin/tambahBerita" class="row" method="POST" enctype="multipart/form-data">
              <div class="col-12">
                <label for="judulBerita" class="col-form-label">Judul Berita</label>
                <textarea class="form-control mb-3" id="judulBerita" name="judulBerita"
                  placeholder="Masukkan judul berita" rows="3" maxlength="300" required></textarea>
              </div>
              <div class="col-12">
                <label for="isiBerita" class="col-form-label">Isi Berita</label>
                <textarea class="form-control mb-3" id="isiBerita" name="isiBerita"
                  placeholder="Masukkan isi berita (maksimal 5 paragraf)" rows="10" required></textarea>
              </div>
    ...
    <script>
      document.getElementById('searchButton').addEventListener('click', function () {
        ...
        if (query) {
          window.location.href = '<?= BASEURL ?>/admin/databerita/search/' + encodeURIComponent(query);
        }
      });
    </script>
